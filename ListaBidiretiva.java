...
public class ListaBidiretiva <X>
{
    private class No
    {
        private X  info;
    ...
    public void guardeUmItemNoFinal (X i) throws Exception
    {
        ...
        else
        {
            ...
            while (atual.getProx()!=null)
                atual=atual.getProx();
            atual.setProx(new No (inserir, null, atual));
        }
    }
    ...
    public boolean equals (Object obj)
    {
        ...
        ListaBidiretiva<X> lista =
       (ListaBidiretiva<X>)obj;
    ...
    // construtor de copia
    public ListaBidiretiva (ListaBidiretiva<X> modelo) throws Exception
    {
        if (modelo==null)
    ...
    public Object clone ()
    {
        ListaBidiretiva<X> ret=null;

        try
        {
            ret = new ListaBidiretiva (this);
        }
